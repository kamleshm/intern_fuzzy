...
EXEC SP_LinRegrSW('tblLinRegrNotExist', '', 3,0.1, 'ynmj321p7z1');
EXEC SP_LinRegrSW('', '', 3,0.1, 'ynmj321p7z2');
EXEC SP_LinRegrSW(NULL, '', 3,0.1, 'ynmj321p7z3');
...
EXEC SP_LinRegrSW('tblLinRegrTest', '', NULL,0.1, 'ynmj321p7z4');
EXEC SP_LinRegrSW('tblLinRegrTest', '', -3,0.1, 'ynmj321p7z5');
EXEC SP_LinRegrSW('tblLinRegrTest', '', 0,0.1, 'ynmj321p7z6');
EXEC SP_LinRegrSW('tblLinRegrTest', '', 20,0.1, 'ynmj321p7z7');

--Param 6
EXEC SP_LinRegrSW('tblLinRegrTest', '', 3,NULL, 'ynmj321p7z8');
EXEC SP_LinRegrSW('tblLinRegrTest', '', 3,-0.1, 'ynmj321p7z9');
EXEC SP_LinRegrSW('tblLinRegrTest', '', 3,10.1, 'ynmj321p7z10');
EXEC SP_LinRegrSW('tblLinRegrTest', '', 3,0, 'ynmj321p7z11');
EXEC SP_LinRegrSW('tblLinRegrTest', '', 3,1, 'ynmj321p7z12');

--Case 3
---- No data in table
DELETE FROM tblLinRegrTest;

EXEC SP_LinRegrSW('tblLinRegrTest', '', 3,0.1, 'ynmj321p7z13');
...
EXEC SP_LinRegrSW('tblLinRegrTest', '', 3,0.1, 'ynmj321p7z14');
...
EXEC SP_LinRegrSW('tblLinRegrTest', '', 3,0.1, 'ynmj321p7z15');
...
EXEC SP_LinRegrSW('tblLinRegrTest', '', 3,0.1, 'ynmj321p7z16');
...
EXEC SP_LinRegrSW('tblLinRegrTest', '', 3,0.1, 'ynmj321p7z17');
...
EXEC SP_LinRegrSW('tblLinRegrTest', '', 3,0.1, 'ynmj321p7z18');
...
EXEC SP_LinRegrSW('tblLinRegrTest', '', 3,0.1, 'ynmj321p7z19');
...
EXEC SP_LinRegrSW('tblLinRegrTest', '', 3,0.1, 'ynmj321p7z21');
...
EXEC SP_LinRegrSW('tblLinRegrTest', '', 3,0.1, 'ynmj321p7z22');
