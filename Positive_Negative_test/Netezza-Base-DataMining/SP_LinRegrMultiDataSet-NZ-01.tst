...
CALL SP_LinRegrMultiDataSet('Dummy', 'HelloWorld');
CALL SP_LinRegrMultiDataSet('', 'HelloWorld');
CALL SP_LinRegrMultiDataSet(NULL, 'HelloWorld');
...
CALL SP_LinRegrMultiDataSet('tblLinRegrMDTest', 'HelloWorld');
