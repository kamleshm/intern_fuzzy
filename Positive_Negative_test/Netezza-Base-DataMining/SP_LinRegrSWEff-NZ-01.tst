...
--
--	Test Unit Number:	SP_LinRegrSWEff-NZ-01
--
--	Name(s):		SP_LinRegrSWEff
--
...
--
-- 	Signature:		SP_LinRegrSWEff(IN   TableName VARCHAR(100), 
...
CALL FLLinRegrSW('tblLinRegrTest', 'ObsCol', 'VarCol', 'NumVal', 0.05,0.1, 'Test', AnalysisID);
