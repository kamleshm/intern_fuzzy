...
--
--	Test Unit Number:	SP_LogRegrSF-NZ-01
--
--	Name(s):		SP_LogRegrSF
--
...
--	Applications:	    	
--
-- 	Signature:		SP_LogRegrSF(IN   TableName     VARCHAR(100), 
...
CALL SP_LogRegrSF('tblLogRegrNotExist', 0.10, 25, '', 'New Test 1');
CALL SP_LogRegrSF('', 0.10, 25, '', 'New Test 1');
CALL SP_LogRegrSF(NULL, 0.10, 25, '', 'New Test 1');
...
--Param5
CALL SP_LogRegrSF('tblLogRegrTest', 0.10, 0, '', 'New Test 1');
CALL SP_LogRegrSF('tblLogRegrTest', 0.10, -1, '', 'New Test 1');

--Param 6
CALL SP_LogRegrSF('tblLogRegrTest', 0, 25, '', 'New Test 1');
CALL SP_LogRegrSF('tblLogRegrTest', -0.1, 25, '', 'New Test 1');
CALL SP_LogRegrSF('tblLogRegrTest', 1, 25, '', 'New Test 1');
CALL SP_LogRegrSF('tblLogRegrTest', 1.1, 25, '', 'New Test 1');

--Case3 ---- No data in table
DELETE FROM tblLogRegrTest ;
CALL SP_LogRegrSF('tblLogRegrTest', 0.10, 25, '', 'New Test 1');
...
CALL SP_LogRegrSF('tblLogRegrTest', 25, 0.10, '', 'New Test 1');
