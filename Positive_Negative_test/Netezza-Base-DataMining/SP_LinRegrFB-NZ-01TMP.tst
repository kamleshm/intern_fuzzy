...
EXEC SP_LinRegrFB('tblLinRegr_NotExist','', 0.50, 0.10, 'p97d4r63bv1' );
---Case 1b
--- NULL table name
EXEC SP_LinRegrFB(NULL,'', 0.50, 0.10, 'p97d4r63bv2' );
---Case 1c
--- Empty string as  table name
EXEC SP_LinRegrFB('','', 0.50, 0.10, 'p97d4r63bv3' );

---Case 2a
---- No data in table
EXEC SP_LinRegrFB('tblLinRegrTest','', 0.50, 0.10, 'p97d4r63bv4' );
...
EXEC SP_LinRegrFB('tblLinRegrTest','', -0.50, 0.10, 'p97d4r63bv5' );

--Case4b 
---Incorrect Values for Highest Prob1 allowed
EXEC SP_LinRegrFB('tblLinRegrTest','', 1.50, 0.10, 'p97d4r63bv6' );

--Case4c 
---Incorrect Values for Highest Prob allowed
EXEC SP_LinRegrFB('tblLinRegrTest','', 0, 0.10, 'p97d4r63bv7' );
--Case4d 
---Incorrect Values for Highest Prob allowed
EXEC SP_LinRegrFB('tblLinRegrTest','', 1.0, 0.10, 'p97d4r63bv8' );

--Case5a 
---Incorrect Values for Highest Prob2 allowed
EXEC SP_LinRegrFB('tblLinRegrTest','', 0.50, -0.10, 'p97d4r63bv9' );

--Case5b 
---Incorrect Values for Highest Prob2 allowed
EXEC SP_LinRegrFB('tblLinRegrTest','', 0.50, 10.10, 'p97d4r63bv10' );

--Case5c 
---Incorrect Values for Highest Prob2 allowed
EXEC SP_LinRegrFB('tblLinRegrTest','', 0.50, 0, 'p97d4r63bv11' );

--Case5d 
---Incorrect Values for Highest Prob allowed
EXEC SP_LinRegrFB('tblLinRegrTest','', 0.50, 1.0, 'p97d4r63bv12' );
...
EXEC SP_LinRegrFB('tblLinRegrTest','', 0.50, 0.10, 'p97d4r63bv13' );
...
EXEC SP_LinRegrFB('tblLinRegrTest','', 0.50, 0.10, 'p97d4r63bv14' );
...
EXEC SP_LinRegrFB('tblLinRegrTest','', 0.50, 0.10, 'p97d4r63bv15' );
...
EXEC SP_LinRegrFB('tblLinRegrTest','', 0.50, 0.10, 'p97d4r63bv16' );
...
EXEC SP_LinRegrFB('tblLinRegrTest','', 0.50, 0.10, 'p97d4r63bv17' );
...
EXEC SP_LinRegrFB('tblLinRegrTest','', 0.50, 0.10, 'p97d4r63bv18' );
...
EXEC SP_LinRegrFB('tblLinRegrTest','', 0.50, 0.10, 'p97d4r63bv19' );
...
EXEC SP_LinRegrFB('tblLinRegrTest','', 0.50, 0.10, 'p97d4r63bv20' );
...
--All varids included
EXEC SP_LinRegrFB('tblLinRegrTest','GSENTEST', 0.50, 0.10, 'p97d4r63bv21' );
...
--All varids  excluded 
EXEC SP_LinRegrFB('tblLinRegrTest','', 0.50, 0.1, 'p97d4r63bv22' );
...
EXEC SP_LinRegrFB('tblLinRegrTest','', 0.50, 0.1, 'p97d4r63bv23' );
...
EXEC SP_LinRegrFB('tblLinRegrTest','', 0.50, 0.1, 'p97d4r63bv24' );
...
EXEC SP_LinRegrFB('tblLinRegrTest','', 0.50, 0.1, 'p97d4r63bv25' );
...
EXEC SP_LinRegrFB('tblLinRegrTest','', 0.50, 0.1, 'p97d4r63bv26' );
...
---- Perform regression with sparse data
EXEC SP_LinRegrFB('tblLinRegrTest','', 0.50, 0.1, 'p97d4r63bv27' );
...
--Test with SpecID
EXEC SP_LinRegrFB('tblLinRegrTest','GSENTEST', 0.50, 0.1, 'p97d4r63bv28' );
