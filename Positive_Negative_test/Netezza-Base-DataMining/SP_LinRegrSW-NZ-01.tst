...
EXEC SP_LinRegrSW('tblLinRegrNotExist', '', 3,0.1, 'HelloWorld');
EXEC SP_LinRegrSW('', '', 3,0.1, 'HelloWorld');
EXEC SP_LinRegrSW(NULL, '', 3,0.1, 'HelloWorld');
...
EXEC SP_LinRegrSW('tblLinRegrTest', '', NULL,0.1, 'HelloWorld');
EXEC SP_LinRegrSW('tblLinRegrTest', '', -3,0.1, 'HelloWorld');
EXEC SP_LinRegrSW('tblLinRegrTest', '', 0,0.1, 'HelloWorld');
EXEC SP_LinRegrSW('tblLinRegrTest', '', 20,0.1, 'HelloWorld');

--Param 6
EXEC SP_LinRegrSW('tblLinRegrTest', '', 3,NULL, 'HelloWorld');
EXEC SP_LinRegrSW('tblLinRegrTest', '', 3,-0.1, 'HelloWorld');
EXEC SP_LinRegrSW('tblLinRegrTest', '', 3,10.1, 'HelloWorld');
EXEC SP_LinRegrSW('tblLinRegrTest', '', 3,0, 'HelloWorld');
EXEC SP_LinRegrSW('tblLinRegrTest', '', 3,1, 'HelloWorld');
