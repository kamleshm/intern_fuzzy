...
CALL SP_LogRegrSWEff('tblLogRegrNotExist', 0.10, 25, '', 0.1,'Test');
CALL SP_LogRegrSWEff('', 0.10, 25, '', 0.1,'Test');
CALL SP_LogRegrSWEff(NULL, 0.10, 25,'', 0.1,'Test');
...
--Param 5
CALL SP_LogRegrSWEff('tblLogRegrTest', -0.10, 25, '', 0.1,'Test');
CALL SP_LogRegrSWEff('tblLogRegrTest', 10.10, 25, '', 0.1,'Test');
CALL SP_LogRegrSWEff('tblLogRegrTest', 0, 25, '', 0.1,'Test');
CALL SP_LogRegrSWEff('tblLogRegrTest', 1, 25, '', 0.1,'Test');
--param 6
CALL SP_LogRegrSWEff('tblLogRegrTest', 0.10, -25, '', 0.1,'Test');
CALL SP_LogRegrSWEff('tblLogRegrTest', 0.10, 0, '', 0.1,'Test');
--param 9
CALL SP_LogRegrSWEff('tblLogRegrTest', 0.10, 25, '', -0.1,'Test');
CALL SP_LogRegrSWEff('tblLogRegrTest', 0.10, 25, '', 0,'Test');
CALL SP_LogRegrSWEff('tblLogRegrTest', 0.10, 25, '', 1,'Test');
CALL SP_LogRegrSWEff('tblLogRegrTest', 0.10, 25, '', 10.1,'Test');
...
--small itearation
CALL SP_LogRegrSWEff('tblLogRegrTest', 0.10, 1, '', 0.1,'Test');
