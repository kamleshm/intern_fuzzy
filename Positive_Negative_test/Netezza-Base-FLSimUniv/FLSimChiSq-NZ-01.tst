...
--
--	Test Unit Number:	FLSimChiSq-NZ-01
--
--	Name(s):		FLSimChiSq
--
...
-- Case 1a:
SELECT a.SerialVal,
	FLSimChiSq(a.RandVal, 3) AS SimChiSq
...
-- Case 1b: DF == 0.0
SELECT a.SerialVal,
	FLSimChiSq(a.RandVal, 0.0) AS SimChiSq
FROM fzzlConstantSerial a
WHERE a.SerialVal <= 5
ORDER BY 1;
...
-- Case 1c: DF > 100.0
SELECT a.SerialVal,
	FLSimChiSq(a.RandVal, 101.0) AS SimChiSq
FROM fzzlConstantSerial a
WHERE a.SerialVal <= 5
ORDER BY 1;    
...
SELECT a.SerialVal,
	FLSimChiSq(a.RandVal) AS SimChiSq
FROM fzzlConstantSerial a
WHERE a.SerialVal <= 5
ORDER BY 1;    
...
SELECT a.SerialVal, 
	FLSimChiSq(a.RandVal, 3, 3.0) AS SimChiSq
FROM fzzlConstantSerial a
WHERE a.SerialVal <= 5
ORDER BY 1;
