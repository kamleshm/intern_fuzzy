...
--
--	Author:			    	<Gandhari.Sen@fuzzyl.com, Zhi.Wang@fuzzyl.com>
--
...
SELECT FLJaroWinklerScore('100','010') AS FLJaroWinklerDist, FLJaroScore('100','010',1) AS FLJaroDist;
SELECT	FLJaroWinklerScore('1000','0100') AS FLJaroWinklerDist, FLJaroScore('1000','0100',1) AS FLJaroDist;
